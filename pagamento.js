...
function calcularFrete() {
    ...
    if (cep === "") {
        // Remove R$ 100,00 do valor total
        var valorAtual = parseFloat(valorTotalElement.innerText.replace("R$ ", ""));
        var novoValor = valorAtual - 100.00;
        valorTotalElement.innerText = "R$ " + novoValor.toFixed(2); // Atualiza o valor total na página
